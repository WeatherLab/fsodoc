...
latex_documents = [
  ('index', 'fso.tex', u'FSO Documentation',
...
#
man_pages = [
    ('FSO', 'FSO', u'Lightweight user-defined software stacks for high-performance computing',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-build', 'ch-build', u'Wrapper for "docker build" that works around some of its annoying behaviors',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-build2dir', 'ch-build2dir', u'Build a FSO image from Dockerfile and unpack it',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-docker2tar', 'ch-docker2tar', u'Flatten a Docker image into a FSO image tarball',
     [u'北京朗润知天科技有限公司'], 1),
    ...
    ('ch-pull2tar', 'ch-pull2tar', u'Pull image from Docker Hub and flatten into tarball',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-run', 'ch-run', u'Run a command in a FSO container',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-ssh', 'ch-ssh', u'Run a remote command in a FSO container',
     [u'北京朗润知天科技有限公司'], 1),
...
texinfo_documents = [
  ('index', 'FSO', u'FSO Documentation',
   u'北京朗润知天科技有限公司', 'fso', 'One line description of project.',
   'Miscellaneous'),
]
